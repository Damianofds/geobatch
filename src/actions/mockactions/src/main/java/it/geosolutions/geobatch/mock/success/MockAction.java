 ...
 *
 */
@Action(configurationClass = MockConfiguration.class)
public class MockAction extends BaseAction<FileSystemEvent> {

    private MockConfiguration configuration;

    public MockAction(MockConfiguration configuration) throws IOException {
        super(configuration);
